<%@ page language="VB" autoeventwireup="false" inherits="Manage_AssignEmployeeShift, App_Web_fzgtou2n" %>
...
<body onload="LoadShiftOrShiftCalndar();SetShiftWhilePostback();">
    ...
    <div>
            <table width="100px"  cellpadding="0" cellspacing="0" style="border-right: gray 1px solid; border-top: gray 1px solid;
                ...
                <tr>
                    ...
                    <tr>
                    <td>
                    <asp:RadioButtonList ID="rbtn_ShiftOrShiftCalendar" runat="server" RepeatDirection="Horizontal"><asp:ListItem Selected="True" onclick="LoadShiftOrShiftCalndar();">Shift</asp:ListItem><asp:ListItem onclick="LoadShiftOrShiftCalndar();">Shift Calendar</asp:ListItem> </asp:RadioButtonList>
                    </td>
                    <td>
                    &nbsp;
                    </td>
