<%@ page language="VB" autoeventwireup="false" inherits="Manage_DepartmentsShifts, App_Web_fzgtou2n" %>
                ...
                <tr>
                    <td colspan="2">
                        <obout:Grid ID="Dg_DepartmentShift" AllowFiltering="true" runat="server" Width="500"
                            ...
                            <Columns>
                                <obout:Column DataField="CompanyDepartmentShiftId" Visible="false" Width="300" HeaderText="DepartmentShiftId"
                                    runat="server" />
                                <obout:Column ID="Column8" DataField="CompanyId" Visible="false" Width="120" HeaderText="Company"
                                    runat="server" />
                                <obout:Column ID="Column9" DataField="DepartmentId" Visible="false" Width="120" HeaderText="Department"
                                    runat="server" />
                                <obout:Column ID="Column1" DataField="CompanySName" Visible="true" Width="140" HeaderText="Company"
                                    runat="server" />
                                <obout:Column ID="Column2" DataField="DepartmentSName" Visible="true" Width="140"
                                    HeaderText="Department" runat="server" />
                                <obout:Column ID="Column3" DataField="ShiftType" Visible="true" Width="100" HeaderText="Shift Type"
                                    runat="server" />
                                <obout:Column ID="Column4" DataField="ShiftSName" Visible="true" Width="140" HeaderText="Shift"
                                    runat="server" />
                                <obout:Column ID="Column10" DataField="ShiftId" Visible="false" Width="120" HeaderText="Department"
                                    runat="server" />
                                <obout:Column ID="Column5" DataField="FromDate" DataFormatString="{0:dd MMM yyyy}"
                                    Visible="true" Width="110" HeaderText="From Date" runat="server" />
                                <obout:Column ID="Column6" DataField="ToDate" DataFormatString="{0:dd MMM yyyy}"
                                    Visible="true" Width="110 " HeaderText="To Date" runat="server" />
                                <obout:Column ID="Column7" DataField="LastModifiedDate" Visible="true" DataFormatString="{0:dd MMM yyyy HH:mm}"
                                    Width="160" HeaderText="Last Modified Date" runat="server" />
