<%@ page language="VB" autoeventwireup="false" inherits="Manage_EmployeeLeaves, App_Web_fzgtou2n" %>
...
<body>
    ...
    <div>
            <table cellpadding="0" cellspacing="0" style="border-right: gray 1px solid; border-top: gray 1px solid;
                ...
                <tr style="padding-left: 5px; font-weight: bold; font-size: 14px; padding-bottom: 3px;
                    color: white; padding-top: 3px; background-color: lightsteelblue">
                    <td colspan="2" style="font-weight: bold; background-color: #ffffff; text-align: left">
        <table id="tblEmp" runat="server">
            <tr>
                <td style="width: 100px; color: black;">
                    Select&nbsp;Employee:</td>
                <td style="width: 100px">
                    <asp:DropDownList ID="ddlEmployee" runat="server" Width="205px" AutoPostBack="false" onchange="someFunction()">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <tr style="padding-right: 5px; padding-left: 1px; padding-bottom: 1px; padding-top: 1px; background-color: lightsteelblue;">
	                ...
	                <asp:DropDownList ID="ddl_EmployeeCode" style="display:none;"  runat="server" Width="205px" AutoPostBack="false" >
                    </asp:DropDownList>
	</td>
                </tr>
            </table>	
    ...
    <script type="text/javascript">
        ...
        function someFunction() {
            ...
            Dg_EmployeeLeaves.refresh();

            var ddlEmployee = document.getElementById("<%=ddlEmployee.ClientID %>");
            var ddlEmployeeCode = document.getElementById("<%=ddl_EmployeeCode.ClientID %>");
            var EmployeeName = document.getElementById("<%=lbl_EmpName.ClientID %>");

            EmployeeName.innerText = ddlEmployeeCode.options[ddlEmployee.selectedIndex].value + ":" + ddlEmployee.options[ddlEmployee.selectedIndex].text;
