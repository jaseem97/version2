<%@ page language="VB" autoeventwireup="false" inherits="Manage_EmployeeOTRegister, App_Web_fzgtou2n" enableeventvalidation="false" %>
        ...
        <table cellpadding="0" cellspacing="0" style="border-right: gray 1px solid; border-top: gray 1px solid;
            ...
            <tr>
                <td colspan="2" style="text-align:center;">
                    ...
                    <asp:Label ID="lbl_Data" runat="server" Text="No Employees Found" Font-Size="12px" ForeColor="Red"></asp:Label>
