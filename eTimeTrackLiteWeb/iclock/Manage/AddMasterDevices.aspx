<%@ page language="VB" autoeventwireup="false" inherits="Manage_AddMasterDevices, eTimeTrackWeb_deploy" enableEventValidation="false" %>
                                ...
                                <table>
                                    <tr>
                                        <td style="width: 198px">
                                            &nbsp;<a style="font-family: Verdana; font-size: 11px; color: #0c416f;" href="MasterSlaveDeviceList.aspx"
                                                class="WebControls">« Go&nbsp;To&nbsp;Master&nbsp;Device</a>
                                        </td>
                                        <td align="right" style="width: 824px">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <asp:Button ID="btn_AddDevice" runat="server" Text="Add Device" Width="170px"
