<%@ page language="VB" autoeventwireup="false" inherits="Manage_BlockUnBlockUsersFromDevice, eTimeTrackWeb_deploy" enableEventValidation="false" %>
            ...
            <table cellpadding="0" cellspacing="0" style="border-right: gray 1px solid; border-top: gray 1px solid;
                    ...
                    <td colspan="2">
                        <div id="div_Employees">
                            <obout:Grid ID="Dg_Employees" runat="server" CallbackMode="true" Serialize="false"
                                ...
                                <Columns>
                                    <obout:Column ID="Column10" Width="70" HeaderText="Select" runat="server">
                                    ...
                                    <obout:Column ID="Column5" DataField="EmployeeDeviceGroup" Visible="true" Width="120"
                                    ...
                                    <obout:Column ID="Column8"  Visible="true" Width="120"
                                     ...
                                     <obout:Column ID="Column9" DataField="FPCount" Visible="true" Width="120"
                                        HeaderText="FingerPrint" runat="server" />
                ...
                <tr>
                    <td align="right"  colspan="2" style=" font-size: 12px; background-color: lightsteelblue;  height: 32px; text-align: center;">
                        &nbsp;
                        <asp:Button ID="btn_BlockUnblock" runat="server" Text="Block" /></td>
                </tr>
            </table>
        </div>
    </form>
