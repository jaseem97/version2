<%@ page language="VB" autoeventwireup="false" inherits="Manage_DeleteUsersFromMultipleDevice, eTimeTrackWeb_deploy" enableeventvalidation="false" %>
            ...
            <table cellpadding="0" cellspacing="0" style="border-right: gray 1px solid; border-top: gray 1px solid;
                ...
                <tr style="font-weight: bold; font-size: 14px; background-color: lightsteelblue;
                    ...
                    <td id="Td1" runat="server" colspan="2" style="font-weight: bold; font-size: 14px;
                        ...
                        Delete Users From Multiple Device <b></b>
                    </td>
                </tr>
                                        ...
                                        <div id="div1">
                                            <obout:Grid ID="grid_Devices" runat="server" CallbackMode="true" Serialize="false" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <obout:Column ID="Column29" DataField="MasterId" Visible="false" Width="148" HeaderText="MasterId"
