<%@ page language="VB" autoeventwireup="false" inherits="Reports_DailyAttendanceReport, eTimeTrackWeb_deploy" enableeventvalidation="false" %>
...
<body onload="chk_FilterEmployee_CheckedChanged();chk_SelectStatus_CheckChanged();chk_FilterCompany_CheckChanged(); chk_FilterDepartment_CheckChanged();chk_FilterShift_CheckChanged();ReportType_OnChange();">
    ...
    <div>
        ...
        <owd:Window ID="ReportProtoType" runat="server" IsModal="true" Height="610" Width="680"
            StyleFolder="~/Styles/mainwindow/blue" Title="Daily Attendance Report" VisibleOnLoad="true"
            ShowCloseButton="true" Left="40" Top="10" ShowStatusBar="False">
            <table width="100%" cellpadding="1" class="Table" style="border-top-style: none;
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;&nbsp;<asp:DropDownList ID="drp_ReportType" runat="server" CssClass="WebControls"
                            onchange="javascript:ReportType_OnChange();">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <fieldset style="border: none">
                            ...
                            <table cellpadding="1">
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="chk_SelectStatus" runat="server" CssClass="WebControls" Text="Select Status"
                                            OnClick="javascript:chk_SelectStatus_CheckChanged();" />
                                    </td>
                                </tr>
                                <tr>
                                </tr>
                                <tr>
                                    <td colspan="5">
                                        <asp:ListBox ID="Lst_SelectStatus" runat="server" CssClass="WebControls" Height="157px"
                                            BorderStyle="Solid" BorderWidth="1px"></asp:ListBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="chk_ContactNo" runat="server" CssClass="WebControls" Text="Show ContactNo. in Remarks"
                                            Checked="true" />
                                    </td>
                                </tr>
                            </table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="chk_FilterShift" runat="server" Text="Filter Shift" CssClass="WebControls"
                            onClick="javascript:chk_FilterShift_CheckChanged();" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:ListBox ID="Lst_FilterCompany" runat="server" Height="125px" Width="135px" CssClass="WebControls"
                            BorderStyle="Solid" BorderWidth="1px" SelectionMode="Multiple"></asp:ListBox>
                    </td>
                    <td colspan="2">
                        <asp:ListBox ID="Lst_FilterDepartment" runat="server" Height="125px" Width="135px"
                            CssClass="WebControls" BorderStyle="Solid" BorderWidth="1px" SelectionMode="Multiple">
                        </asp:ListBox>
                    </td>
                    <td>
                        <asp:ListBox ID="Lst_FilterShift" runat="server" Height="125px" Width="135px" CssClass="WebControls"
                            BorderStyle="Solid" BorderWidth="1px" SelectionMode="Multiple"></asp:ListBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:LinkButton ID="Lnk_SelectAllShift" runat="server" CssClass="WebControls" OnClientClick="return SelectAll(this);">Select All</asp:LinkButton>
                        &nbsp;&nbsp;
                        <asp:LinkButton ID="Lnk_DeSelectAllShift" runat="server" CssClass="WebControls" OnClientClick="return DeSelectAll(this);">Deselect All</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        <asp:CheckBox ID="chk_RecalculateAttendance" CssClass="WebControls" runat="server"
                            Text="Recalculate Attendance" />&nbsp;<asp:CheckBox ID="chk_ShowCompanyLogo" Checked="true"
                                Text="Show Company Logo" runat="server" />
                    </td>
        ...
        <asp:LinkButton ID="Lnk_SelectAllDepartment" Visible="false" runat="server" CssClass="WebControls"
            OnClientClick="return SelectAll(this);">Select All</asp:LinkButton>
        &nbsp;&nbsp;
        <asp:LinkButton ID="Lnk_DeSelectAllDepartment" runat="server" Visible="false" CssClass="WebControls"
            OnClientClick="return DeSelectAll(this);">Deselect All</asp:LinkButton>
    </div>
...
<script type="text/javascript">
    ...
    function chk_SelectStatus_CheckChanged() {

        var checkStatus = document.getElementById("<%=chk_SelectStatus.ClientId %>").checked;


        if (checkStatus) {
            document.getElementById("<%=Lst_SelectStatus.ClientId %>").disabled = false;

        }
        else {
            document.getElementById("<%=Lst_SelectStatus.ClientId %>").disabled = true;
    ...
    function ReportType_OnChange() {
        //	                     var Sender=document.getElementById("<%=drp_ReportType.ClientID %>").value;
        ...
        if (Value == 'Detailed Report' || Value == 'CSV Export' || Value == 'In Out Duration Report') {
            document.getElementById("<%=chk_ContactNo.ClientID %>").disabled = true;
            document.getElementById("<%=chk_ContactNo.ClientID %>").checked = false;
        }

        else {
            document.getElementById("<%=chk_ContactNo.ClientID %>").disabled = false;
        }

        if (Value == 'CSV Export') {
            document.getElementById("<%=chk_ShowCompanyLogo.ClientID %>").checked = false;
            document.getElementById("<%=chk_ShowCompanyLogo.ClientID %>").disabled = true;
        }
        else {
            document.getElementById("<%=chk_ShowCompanyLogo.ClientID %>").disabled = false;
        }

        if (Value == 'Detailed Report' || Value == 'Basic Report') {
            document.getElementById("<%=drp_GroupOrder.ClientID %>").disabled = false;
            document.getElementById("<%=lbl_GroupBy.ClientID %>").disabled = false;
        }
        else {
            document.getElementById("<%=drp_GroupOrder.ClientID %>").disabled = true;
            document.getElementById("<%=lbl_GroupBy.ClientID %>").disabled = true;
        }
    }
    ...
    function SelectAll(Sender) {
        ...
        if (FieldName == 'ReportProtoType_Lnk_SelectStatusAll') {

            var ListViewObject = document.getElementById("<%=Lst_SelectStatus.ClientID %>");
        ...
        else if (FieldName == 'ReportProtoType_Lnk_SelectAllCompany') {
    ...
    function DeSelectAll(Sender) {
        ...
        if (FieldName == 'ReportProtoType_Lnk_DeSelectStatusAll') {
        ...
        else if (FieldName == 'ReportProtoType_Lnk_DeSelectAllCompany') {
            var ListViewObject = document.getElementById("<%=Lst_FilterCompany.ClientID %>");
            for (var j = 0; j < ListViewObject.options.length; j++) {
                ListViewObject.options[j].selected = false;
            }
